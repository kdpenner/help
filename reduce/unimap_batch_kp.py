...
########TASK Execution #############
    ...
    os.system('python '+os.path.dirname(help.__file__)+'/reduce/alignmap.py --hipe '+dir_pre+'correctscans/scan'+strobsid+camera+'.fits '+catfname+' '+dir_pre+'correctscans/shifts'+strobsid+camera+'.txt --unimap '+inOutDir+'/'+tag+'/'+camera+'/unimap_obsid_'+tag+'_'+camera+'_'+strobsid+'.fits')